...
public class DatabaseTotalFightRankPlayerAllWold implements DatabaseTableDataBase<DatabaseTotalFightRankPlayerAllWold>,Serializable {
    public static final String TableName = "totalFightRankPlayerAllWold";
    /** 玩家ID */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseTotalFightRankPlayerAllWold __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseTotalFightRankPlayerAllWold();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseTotalFightRankPlayerAllWold diff()
    {
        DatabaseTotalFightRankPlayerAllWold ret = new DatabaseTotalFightRankPlayerAllWold();
    ...
    @Override
    public void set(DatabaseTotalFightRankPlayerAllWold value) {
        this.id = value.id;
    ...
    public String getTableName() {
        return "totalFightRankPlayerAllWold";
    }
    @Override
    public void check() {
    }
