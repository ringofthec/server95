...
public class DatabaseLevel_rank implements DatabaseTableDataBase<DatabaseLevel_rank>,Serializable {
    public static final String TableName = "level_rank";
    /**  */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseLevel_rank __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseLevel_rank();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseLevel_rank diff()
    {
        DatabaseLevel_rank ret = new DatabaseLevel_rank();
    ...
    @Override
    public void set(DatabaseLevel_rank value) {
