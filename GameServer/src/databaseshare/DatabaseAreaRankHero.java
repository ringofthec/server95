...
public class DatabaseAreaRankHero implements DatabaseTableDataBase<DatabaseAreaRankHero>,Serializable {
    public static final String TableName = "areaRankHero";
    /** 本表ID */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseAreaRankHero __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseAreaRankHero();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseAreaRankHero diff()
    {
        DatabaseAreaRankHero ret = new DatabaseAreaRankHero();
    ...
    @Override
    public void set(DatabaseAreaRankHero value) {
        this.id = value.id;
