...
public class DatabaseMoney_rank implements DatabaseTableDataBase<DatabaseMoney_rank>,Serializable {
    public static final String TableName = "money_rank";
    /**  */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseMoney_rank __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseMoney_rank();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseMoney_rank diff()
    {
        DatabaseMoney_rank ret = new DatabaseMoney_rank();
    ...
    @Override
    public void set(DatabaseMoney_rank value) {
