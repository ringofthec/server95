...
public class DatabaseAreaLegionRank implements DatabaseTableDataBase<DatabaseAreaLegionRank>,Serializable {
    public static final String TableName = "areaLegionRank";
    /**  */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseAreaLegionRank __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseAreaLegionRank();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseAreaLegionRank diff()
    {
        DatabaseAreaLegionRank ret = new DatabaseAreaLegionRank();
    ...
    @Override
    public void set(DatabaseAreaLegionRank value) {
        this.id = value.id;
