...
public class DatabaseTotalFightRankPlayerServer implements DatabaseTableDataBase<DatabaseTotalFightRankPlayerServer>,Serializable {
    public static final String TableName = "totalFightRankPlayerServer";
    /** 玩家ID */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseTotalFightRankPlayerServer __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseTotalFightRankPlayerServer();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseTotalFightRankPlayerServer diff()
    {
        DatabaseTotalFightRankPlayerServer ret = new DatabaseTotalFightRankPlayerServer();
    ...
    @Override
    public void set(DatabaseTotalFightRankPlayerServer value) {
        this.id = value.id;
    ...
    public String getTableName() {
        return "totalFightRankPlayerServer";
    }
    @Override
    public void check() {
    }
