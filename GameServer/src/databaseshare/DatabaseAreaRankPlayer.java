...
public class DatabaseAreaRankPlayer implements DatabaseTableDataBase<DatabaseAreaRankPlayer>,Serializable {
    public static final String TableName = "areaRankPlayer";
    /** 玩家ID */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseAreaRankPlayer __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseAreaRankPlayer();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseAreaRankPlayer diff()
    {
        DatabaseAreaRankPlayer ret = new DatabaseAreaRankPlayer();
    ...
    @Override
    public void set(DatabaseAreaRankPlayer value) {
        this.id = value.id;
