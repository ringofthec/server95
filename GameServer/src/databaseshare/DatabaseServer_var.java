...
public class DatabaseServer_var implements DatabaseTableDataBase<DatabaseServer_var>,Serializable {
    public static final String TableName = "server_var";
    /** 变量名称 */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseServer_var __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseServer_var();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseServer_var diff()
    {
        DatabaseServer_var ret = new DatabaseServer_var();
    ...
    @Override
    public void set(DatabaseServer_var value) {
