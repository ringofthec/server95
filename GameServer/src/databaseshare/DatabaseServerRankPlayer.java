...
public class DatabaseServerRankPlayer implements DatabaseTableDataBase<DatabaseServerRankPlayer>,Serializable {
    public static final String TableName = "serverRankPlayer";
    /** 玩家ID */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseServerRankPlayer __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseServerRankPlayer();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseServerRankPlayer diff()
    {
        DatabaseServerRankPlayer ret = new DatabaseServerRankPlayer();
    ...
    @Override
    public void set(DatabaseServerRankPlayer value) {
        this.id = value.id;
