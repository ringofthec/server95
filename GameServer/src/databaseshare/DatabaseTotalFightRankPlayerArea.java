...
public class DatabaseTotalFightRankPlayerArea implements DatabaseTableDataBase<DatabaseTotalFightRankPlayerArea>,Serializable {
    public static final String TableName = "totalFightRankPlayerArea";
    /** 玩家ID */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseTotalFightRankPlayerArea __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseTotalFightRankPlayerArea();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseTotalFightRankPlayerArea diff()
    {
        DatabaseTotalFightRankPlayerArea ret = new DatabaseTotalFightRankPlayerArea();
    ...
    @Override
    public void set(DatabaseTotalFightRankPlayerArea value) {
        this.id = value.id;
    ...
    public String getTableName() {
        return "totalFightRankPlayerArea";
    }
    @Override
    public void check() {
    }
