...
public class DatabaseMomey_stat_inc_log implements DatabaseTableDataBase<DatabaseMomey_stat_inc_log>,Serializable {
    public static final String TableName = "momey_stat_inc_log";
    /** channel_id */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseMomey_stat_inc_log __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseMomey_stat_inc_log();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseMomey_stat_inc_log diff()
    {
        DatabaseMomey_stat_inc_log ret = new DatabaseMomey_stat_inc_log();
    ...
    @Override
    public void set(DatabaseMomey_stat_inc_log value) {
