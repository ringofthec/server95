...
public class DatabasePlayerFightRank implements DatabaseTableDataBase<DatabasePlayerFightRank>,Serializable {
    public static final String TableName = "playerFightRank";
    /**  */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabasePlayerFightRank __self = null;
    @Override
    public void sync()
    {
        __self = new DatabasePlayerFightRank();
        __self.set(this);
    }
    ...
    @Override
    public DatabasePlayerFightRank diff()
    {
        DatabasePlayerFightRank ret = new DatabasePlayerFightRank();
    ...
    @Override
    public void set(DatabasePlayerFightRank value) {
        this.id = value.id;
