...
public class DatabaseRankHero implements DatabaseTableDataBase<DatabaseRankHero>,Serializable {
    public static final String TableName = "rankHero";
    /** 本表ID */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseRankHero __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseRankHero();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseRankHero diff()
    {
        DatabaseRankHero ret = new DatabaseRankHero();
    ...
    @Override
    public void set(DatabaseRankHero value) {
        this.id = value.id;
