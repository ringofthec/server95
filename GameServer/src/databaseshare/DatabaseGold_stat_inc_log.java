...
public class DatabaseGold_stat_inc_log implements DatabaseTableDataBase<DatabaseGold_stat_inc_log>,Serializable {
    public static final String TableName = "gold_stat_inc_log";
    /** channel_id */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseGold_stat_inc_log __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseGold_stat_inc_log();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseGold_stat_inc_log diff()
    {
        DatabaseGold_stat_inc_log ret = new DatabaseGold_stat_inc_log();
    ...
    @Override
    public void set(DatabaseGold_stat_inc_log value) {
