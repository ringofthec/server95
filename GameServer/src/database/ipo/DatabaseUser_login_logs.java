...
public class DatabaseUser_login_logs implements DatabaseTableDataBase<DatabaseUser_login_logs>,Serializable {
    public static final String TableName = "user_login_logs";
    /** 项目id */
    ...
    /** 克隆对象 用于获取改变的字段 */
    private DatabaseUser_login_logs __self = null;
    @Override
    public void sync()
    {
        __self = new DatabaseUser_login_logs();
        __self.set(this);
    }
    ...
    @Override
    public DatabaseUser_login_logs diff()
    {
        DatabaseUser_login_logs ret = new DatabaseUser_login_logs();
    ...
    @Override
    public void set(DatabaseUser_login_logs value) {
