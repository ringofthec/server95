...
public class DatabaseLevReward implements DatabaseTableDataBase<DatabaseLevReward>,Serializable {
    ...
    /** 奖励ID */
    @DatabaseFieldAttribute(fieldName = "levReward_id",fieldType = Integer.class,arrayType = Byte.class)
    public Integer levReward_id = null;
    public Integer getLevReward_id() {return levReward_id;}
    /** 玩家ID */
