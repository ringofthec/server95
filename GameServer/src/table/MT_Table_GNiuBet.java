...
public class MT_Table_GNiuBet extends MT_TableBase {
	final String FILE_MD5_CODE = "baf10466aeacdf8e167a9e4fd9df4b33";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GNiuBet> m_dataArray = new HashMap<Integer,MT_Data_GNiuBet>();

    public MT_Table_GNiuBet (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GNiuBet pData = MT_Data_GNiuBet.ReadMemory(reader, fileName);
	...
	public MT_Data_GNiuBet GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GNiuBet key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GNiuBet> Datas() {
		return m_dataArray;
	}
