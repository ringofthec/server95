...
public class MT_Table_GSlotsJZActiveReward extends MT_TableBase {
	final String FILE_MD5_CODE = "e4654ebc200428c27c364af8712e0f09";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsJZActiveReward> m_dataArray = new HashMap<Integer,MT_Data_GSlotsJZActiveReward>();

    public MT_Table_GSlotsJZActiveReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsJZActiveReward pData = MT_Data_GSlotsJZActiveReward.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsJZActiveReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsJZActiveReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsJZActiveReward> Datas() {
		return m_dataArray;
	}
