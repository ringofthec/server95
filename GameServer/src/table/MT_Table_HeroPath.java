...
public class MT_Table_HeroPath extends MT_TableBase {
	final String FILE_MD5_CODE = "770357b074abecc427da9ef41d941fa1";
    private String fileName = "";
    private HashMap<Integer,MT_Data_HeroPath> m_dataArray = new HashMap<Integer,MT_Data_HeroPath>();

    public MT_Table_HeroPath (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_HeroPath pData = MT_Data_HeroPath.ReadMemory(reader, fileName);
	...
	public MT_Data_HeroPath GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_HeroPath key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_HeroPath> Datas() {
		return m_dataArray;
	}
