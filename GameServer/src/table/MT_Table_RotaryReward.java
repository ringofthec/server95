...
public class MT_Table_RotaryReward extends MT_TableBase {
	final String FILE_MD5_CODE = "f22e7c7c180704590a9ed4710ca0b851";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_RotaryReward> m_dataArray = new HashMap<Integer,MT_Data_RotaryReward>();

    public MT_Table_RotaryReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_RotaryReward pData = MT_Data_RotaryReward.ReadMemory(reader, fileName);
	...
	public MT_Data_RotaryReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_RotaryReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_RotaryReward> Datas() {
		return m_dataArray;
	}
