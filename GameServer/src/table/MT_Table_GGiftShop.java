...
public class MT_Table_GGiftShop extends MT_TableBase {
	final String FILE_MD5_CODE = "0a83c9161139af6b8097b29b5b9f4e99";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GGiftShop> m_dataArray = new HashMap<Integer,MT_Data_GGiftShop>();

    public MT_Table_GGiftShop (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GGiftShop pData = MT_Data_GGiftShop.ReadMemory(reader, fileName);
	...
	public MT_Data_GGiftShop GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GGiftShop key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GGiftShop> Datas() {
		return m_dataArray;
	}
