...
public class MT_Table_Rank extends MT_TableBase {
	final String FILE_MD5_CODE = "724f4161d2d2ed8cc87f33f5d74e5ce1";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Rank> m_dataArray = new HashMap<Integer,MT_Data_Rank>();

    public MT_Table_Rank (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Rank pData = MT_Data_Rank.ReadMemory(reader, fileName);
	...
	public MT_Data_Rank GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Rank key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Rank> Datas() {
		return m_dataArray;
	}
