...
public class MT_Table_LuckDrawMedal extends MT_TableBase {
	final String FILE_MD5_CODE = "a4faed6bbaaf7c6b228e6b846d7df15d";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LuckDrawMedal> m_dataArray = new HashMap<Integer,MT_Data_LuckDrawMedal>();

    public MT_Table_LuckDrawMedal (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LuckDrawMedal pData = MT_Data_LuckDrawMedal.ReadMemory(reader, fileName);
	...
	public MT_Data_LuckDrawMedal GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LuckDrawMedal key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LuckDrawMedal> Datas() {
		return m_dataArray;
	}
