...
public class MT_Table_GSlotsMoney extends MT_TableBase {
	final String FILE_MD5_CODE = "085b23a35bcd0543a61c93354a563513";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsMoney> m_dataArray = new HashMap<Integer,MT_Data_GSlotsMoney>();

    public MT_Table_GSlotsMoney (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsMoney pData = MT_Data_GSlotsMoney.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsMoney GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsMoney key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsMoney> Datas() {
		return m_dataArray;
	}
