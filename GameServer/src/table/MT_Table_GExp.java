...
public class MT_Table_GExp extends MT_TableBase {
	final String FILE_MD5_CODE = "3d8d6eb45914f1a211e6e63f9e7a692d";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GExp> m_dataArray = new HashMap<Integer,MT_Data_GExp>();

    public MT_Table_GExp (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GExp pData = MT_Data_GExp.ReadMemory(reader, fileName);
	...
	public MT_Data_GExp GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GExp key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GExp> Datas() {
		return m_dataArray;
	}
