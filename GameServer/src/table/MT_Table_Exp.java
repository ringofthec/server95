...
public class MT_Table_Exp extends MT_TableBase {
	final String FILE_MD5_CODE = "a71dba788a9a0f08a4fc4c4cee7c3830";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Exp> m_dataArray = new HashMap<Integer,MT_Data_Exp>();

    public MT_Table_Exp (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Exp pData = MT_Data_Exp.ReadMemory(reader, fileName);
	...
	public MT_Data_Exp GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Exp key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Exp> Datas() {
		return m_dataArray;
	}
