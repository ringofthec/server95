...
public class MT_Table_GNotice extends MT_TableBase {
	final String FILE_MD5_CODE = "168c31041bbee977f7e109b78ea7cb29";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GNotice> m_dataArray = new HashMap<Integer,MT_Data_GNotice>();

    public MT_Table_GNotice (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GNotice pData = MT_Data_GNotice.ReadMemory(reader, fileName);
	...
	public MT_Data_GNotice GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GNotice key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GNotice> Datas() {
		return m_dataArray;
	}
