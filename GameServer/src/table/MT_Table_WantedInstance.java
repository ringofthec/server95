...
public class MT_Table_WantedInstance extends MT_TableBase {
	final String FILE_MD5_CODE = "c0b4812e6f9df0f9db3dd39345dcfe51";
    private String fileName = "";
    private HashMap<Integer,MT_Data_WantedInstance> m_dataArray = new HashMap<Integer,MT_Data_WantedInstance>();

    public MT_Table_WantedInstance (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_WantedInstance pData = MT_Data_WantedInstance.ReadMemory(reader, fileName);
	...
	public MT_Data_WantedInstance GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_WantedInstance key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_WantedInstance> Datas() {
		return m_dataArray;
	}
