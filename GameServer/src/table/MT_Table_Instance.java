...
public class MT_Table_Instance extends MT_TableBase {
	final String FILE_MD5_CODE = "360a925c4756e6e588f9f023c9816b9c";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Instance> m_dataArray = new HashMap<Integer,MT_Data_Instance>();

    public MT_Table_Instance (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Instance pData = MT_Data_Instance.ReadMemory(reader, fileName);
	...
	public MT_Data_Instance GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Instance key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Instance> Datas() {
		return m_dataArray;
	}
