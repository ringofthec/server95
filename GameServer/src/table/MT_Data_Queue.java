...
public class MT_Data_Queue extends MT_DataBase {
    ...
    public static MT_Data_Queue ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_Queue Data = new MT_Data_Queue();
