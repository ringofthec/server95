...
public class MT_Table_HeroPathConfig extends MT_TableBase {
	final String FILE_MD5_CODE = "74f00cd52c9615bdc80738a12d6ba87c";
    private String fileName = "";
    private HashMap<Integer,MT_Data_HeroPathConfig> m_dataArray = new HashMap<Integer,MT_Data_HeroPathConfig>();

    public MT_Table_HeroPathConfig (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_HeroPathConfig pData = MT_Data_HeroPathConfig.ReadMemory(reader, fileName);
	...
	public MT_Data_HeroPathConfig GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_HeroPathConfig key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_HeroPathConfig> Datas() {
		return m_dataArray;
	}
