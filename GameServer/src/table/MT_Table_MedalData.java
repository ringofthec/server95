...
public class MT_Table_MedalData extends MT_TableBase {
	final String FILE_MD5_CODE = "1bbadbda8c9c29b9f11c6ec14cfcc9ec";
    private String fileName = "";
    private HashMap<Integer,MT_Data_MedalData> m_dataArray = new HashMap<Integer,MT_Data_MedalData>();

    public MT_Table_MedalData (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_MedalData pData = MT_Data_MedalData.ReadMemory(reader, fileName);
	...
	public MT_Data_MedalData GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_MedalData key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_MedalData> Datas() {
		return m_dataArray;
	}
