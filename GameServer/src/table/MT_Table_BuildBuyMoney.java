...
public class MT_Table_BuildBuyMoney extends MT_TableBase {
	final String FILE_MD5_CODE = "6fe3e1ad854dce30cb4e306d57bcf28a";
    private String fileName = "";
    private HashMap<Integer,MT_Data_BuildBuyMoney> m_dataArray = new HashMap<Integer,MT_Data_BuildBuyMoney>();

    public MT_Table_BuildBuyMoney (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_BuildBuyMoney pData = MT_Data_BuildBuyMoney.ReadMemory(reader, fileName);
	...
	public MT_Data_BuildBuyMoney GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_BuildBuyMoney key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_BuildBuyMoney> Datas() {
		return m_dataArray;
	}
