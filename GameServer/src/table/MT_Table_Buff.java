...
public class MT_Table_Buff extends MT_TableBase {
	final String FILE_MD5_CODE = "7e41bf1dce6d8cc0011ac006418f6d66";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Buff> m_dataArray = new HashMap<Integer,MT_Data_Buff>();

    public MT_Table_Buff (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Buff pData = MT_Data_Buff.ReadMemory(reader, fileName);
	...
	public MT_Data_Buff GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Buff key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Buff> Datas() {
		return m_dataArray;
	}
