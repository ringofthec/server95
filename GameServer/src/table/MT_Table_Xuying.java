...
public class MT_Table_Xuying extends MT_TableBase {
	final String FILE_MD5_CODE = "894c24dd33bcae8d8c8600f3c34927d5";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Xuying> m_dataArray = new HashMap<Integer,MT_Data_Xuying>();

    public MT_Table_Xuying (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Xuying pData = MT_Data_Xuying.ReadMemory(reader, fileName);
	...
	public MT_Data_Xuying GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Xuying key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Xuying> Datas() {
		return m_dataArray;
	}
