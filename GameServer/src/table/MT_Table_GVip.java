...
public class MT_Table_GVip extends MT_TableBase {
	final String FILE_MD5_CODE = "07f54c2a98276bd4f1c3d5ee970073b3";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GVip> m_dataArray = new HashMap<Integer,MT_Data_GVip>();

    public MT_Table_GVip (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GVip pData = MT_Data_GVip.ReadMemory(reader, fileName);
	...
	public MT_Data_GVip GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GVip key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GVip> Datas() {
		return m_dataArray;
	}
