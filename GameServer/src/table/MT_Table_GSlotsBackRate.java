...
public class MT_Table_GSlotsBackRate extends MT_TableBase {
	final String FILE_MD5_CODE = "3fd6748a9ed99d4f526de112d06701d9";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsBackRate> m_dataArray = new HashMap<Integer,MT_Data_GSlotsBackRate>();

    public MT_Table_GSlotsBackRate (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsBackRate pData = MT_Data_GSlotsBackRate.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsBackRate GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsBackRate key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsBackRate> Datas() {
		return m_dataArray;
	}
