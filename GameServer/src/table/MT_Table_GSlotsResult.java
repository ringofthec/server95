...
public class MT_Table_GSlotsResult extends MT_TableBase {
	final String FILE_MD5_CODE = "9c9f1eccc84b8ec58201d107d36a773c";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsResult> m_dataArray = new HashMap<Integer,MT_Data_GSlotsResult>();

    public MT_Table_GSlotsResult (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsResult pData = MT_Data_GSlotsResult.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsResult GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsResult key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsResult> Datas() {
		return m_dataArray;
	}
