...
public class MT_Table_LegionPlayerExp extends MT_TableBase {
	final String FILE_MD5_CODE = "87538bc05179331a10e92e70308bdf33";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LegionPlayerExp> m_dataArray = new HashMap<Integer,MT_Data_LegionPlayerExp>();

    public MT_Table_LegionPlayerExp (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LegionPlayerExp pData = MT_Data_LegionPlayerExp.ReadMemory(reader, fileName);
	...
	public MT_Data_LegionPlayerExp GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LegionPlayerExp key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LegionPlayerExp> Datas() {
		return m_dataArray;
	}
