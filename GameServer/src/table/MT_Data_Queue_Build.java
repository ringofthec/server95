...
public class MT_Data_Queue_Build extends MT_DataBase {
    ...
    public static MT_Data_Queue_Build ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_Queue_Build Data = new MT_Data_Queue_Build();
