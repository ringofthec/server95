...
public class MT_Table_GuideLimit extends MT_TableBase {
	final String FILE_MD5_CODE = "7f6e26a67058f01a163d1b8a7044a9a8";
    private String fileName = "";
    private HashMap<Integer,MT_Data_GuideLimit> m_dataArray = new HashMap<Integer,MT_Data_GuideLimit>();

    public MT_Table_GuideLimit (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GuideLimit pData = MT_Data_GuideLimit.ReadMemory(reader, fileName);
	...
	public MT_Data_GuideLimit GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GuideLimit key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GuideLimit> Datas() {
		return m_dataArray;
	}
