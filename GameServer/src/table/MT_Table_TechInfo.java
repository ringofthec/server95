...
public class MT_Table_TechInfo extends MT_TableBase {
	final String FILE_MD5_CODE = "9e7fbfa94c1eda5d84f71dd17c5dcbef";
    private String fileName = "";
    private HashMap<Integer,MT_Data_TechInfo> m_dataArray = new HashMap<Integer,MT_Data_TechInfo>();

    public MT_Table_TechInfo (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_TechInfo pData = MT_Data_TechInfo.ReadMemory(reader, fileName);
	...
	public MT_Data_TechInfo GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_TechInfo key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_TechInfo> Datas() {
		return m_dataArray;
	}
