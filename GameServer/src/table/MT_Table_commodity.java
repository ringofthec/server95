...
public class MT_Table_commodity extends MT_TableBase {
	final String FILE_MD5_CODE = "76c7997b18ddd3365e5e49f6f52ec4e7";
    private String fileName = "";
    private HashMap<Integer,MT_Data_commodity> m_dataArray = new HashMap<Integer,MT_Data_commodity>();

    public MT_Table_commodity (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_commodity pData = MT_Data_commodity.ReadMemory(reader, fileName);
	...
	public MT_Data_commodity GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_commodity key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_commodity> Datas() {
		return m_dataArray;
	}
