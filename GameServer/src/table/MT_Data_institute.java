...
public class MT_Data_institute extends MT_DataBase {
    ...
    public static MT_Data_institute ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_institute Data = new MT_Data_institute();
