...
public class MT_Table_AirBase extends MT_TableBase {
	final String FILE_MD5_CODE = "49b958ea7a4a6a9955bd24777aaba9fe";
    private String fileName = "";
    private HashMap<Integer,MT_Data_AirBase> m_dataArray = new HashMap<Integer,MT_Data_AirBase>();

    public MT_Table_AirBase (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_AirBase pData = MT_Data_AirBase.ReadMemory(reader, fileName);
	...
	public MT_Data_AirBase GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_AirBase key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_AirBase> Datas() {
		return m_dataArray;
	}
