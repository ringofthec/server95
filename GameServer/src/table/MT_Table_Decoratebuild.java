...
public class MT_Table_Decoratebuild extends MT_TableBase {
	final String FILE_MD5_CODE = "5e6f1b936e40a9b62f2f48bbc261b74c";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Decoratebuild> m_dataArray = new HashMap<Integer,MT_Data_Decoratebuild>();

    public MT_Table_Decoratebuild (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Decoratebuild pData = MT_Data_Decoratebuild.ReadMemory(reader, fileName);
	...
	public MT_Data_Decoratebuild GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Decoratebuild key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Decoratebuild> Datas() {
		return m_dataArray;
	}
