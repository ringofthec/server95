...
public class MT_Table_legion extends MT_TableBase {
	final String FILE_MD5_CODE = "c71e4f02e79013791a2f581cc7310ca3";
    private String fileName = "";
    private HashMap<Integer,MT_Data_legion> m_dataArray = new HashMap<Integer,MT_Data_legion>();

    public MT_Table_legion (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_legion pData = MT_Data_legion.ReadMemory(reader, fileName);
	...
	public MT_Data_legion GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_legion key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_legion> Datas() {
		return m_dataArray;
	}
