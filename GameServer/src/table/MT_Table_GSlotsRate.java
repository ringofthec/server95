...
public class MT_Table_GSlotsRate extends MT_TableBase {
	final String FILE_MD5_CODE = "41ba60b51edbeb27f56c146e9c9d76dd";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsRate> m_dataArray = new HashMap<Integer,MT_Data_GSlotsRate>();

    public MT_Table_GSlotsRate (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsRate pData = MT_Data_GSlotsRate.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsRate GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsRate key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsRate> Datas() {
		return m_dataArray;
	}
