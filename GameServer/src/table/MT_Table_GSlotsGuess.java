...
public class MT_Table_GSlotsGuess extends MT_TableBase {
	final String FILE_MD5_CODE = "5859fdb0998061f610bca755deac4f00";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsGuess> m_dataArray = new HashMap<Integer,MT_Data_GSlotsGuess>();

    public MT_Table_GSlotsGuess (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsGuess pData = MT_Data_GSlotsGuess.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsGuess GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsGuess key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsGuess> Datas() {
		return m_dataArray;
	}
