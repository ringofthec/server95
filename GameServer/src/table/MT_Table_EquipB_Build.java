...
public class MT_Table_EquipB_Build extends MT_TableBase {
	final String FILE_MD5_CODE = "31f67aea39c25b0c9461c9b9bbbc1f4f";
    private String fileName = "";
    private HashMap<Integer,MT_Data_EquipB_Build> m_dataArray = new HashMap<Integer,MT_Data_EquipB_Build>();

    public MT_Table_EquipB_Build (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_EquipB_Build pData = MT_Data_EquipB_Build.ReadMemory(reader, fileName);
	...
	public MT_Data_EquipB_Build GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_EquipB_Build key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_EquipB_Build> Datas() {
		return m_dataArray;
	}
