...
public class MT_Table_Active extends MT_TableBase {
	final String FILE_MD5_CODE = "5f9666b8380276197fe544cb7e0f1e0d";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Active> m_dataArray = new HashMap<Integer,MT_Data_Active>();

    public MT_Table_Active (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Active pData = MT_Data_Active.ReadMemory(reader, fileName);
	...
	public final HashMap<Integer,MT_Data_Active> Datas() {
		return m_dataArray;
	}
