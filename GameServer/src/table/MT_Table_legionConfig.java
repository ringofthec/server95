...
public class MT_Table_legionConfig extends MT_TableBase {
	final String FILE_MD5_CODE = "cba529f84881da7277482678ec1d1a53";
    private String fileName = "";
    private HashMap<Integer,MT_Data_legionConfig> m_dataArray = new HashMap<Integer,MT_Data_legionConfig>();

    public MT_Table_legionConfig (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_legionConfig pData = MT_Data_legionConfig.ReadMemory(reader, fileName);
	...
	public MT_Data_legionConfig GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_legionConfig key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_legionConfig> Datas() {
		return m_dataArray;
	}
