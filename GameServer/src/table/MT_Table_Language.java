...
public class MT_Table_Language extends MT_TableBase {
	final String FILE_MD5_CODE = "d36ddc515f0354dd5c43c7ebdbbac1b0";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Language> m_dataArray = new HashMap<Integer,MT_Data_Language>();

    public MT_Table_Language (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Language pData = MT_Data_Language.ReadMemory(reader, fileName);
	...
	public MT_Data_Language GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Language key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Language> Datas() {
		return m_dataArray;
	}
