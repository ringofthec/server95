...
public class MT_Table_LevelReward extends MT_TableBase {
	final String FILE_MD5_CODE = "ba285416662cedb9d8bbdbd3f3c7585e";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LevelReward> m_dataArray = new HashMap<Integer,MT_Data_LevelReward>();

    public MT_Table_LevelReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LevelReward pData = MT_Data_LevelReward.ReadMemory(reader, fileName);
	...
	public MT_Data_LevelReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LevelReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LevelReward> Datas() {
		return m_dataArray;
	}
