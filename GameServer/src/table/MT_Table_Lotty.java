...
public class MT_Table_Lotty extends MT_TableBase {
	final String FILE_MD5_CODE = "b922449ef9d0e926df44cad13c46cbd9";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_Lotty> m_dataArray = new HashMap<Integer,MT_Data_Lotty>();

    public MT_Table_Lotty (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Lotty pData = MT_Data_Lotty.ReadMemory(reader, fileName);
	...
	public MT_Data_Lotty GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Lotty key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Lotty> Datas() {
		return m_dataArray;
	}
