...
public class MT_Table_Language_Chinese_Simplified extends MT_TableBase {
	final String FILE_MD5_CODE = "d36ddc515f0354dd5c43c7ebdbbac1b0";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_Language_Chinese_Simplified> m_dataArray = new HashMap<Integer,MT_Data_Language_Chinese_Simplified>();

    public MT_Table_Language_Chinese_Simplified (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Language_Chinese_Simplified pData = MT_Data_Language_Chinese_Simplified.ReadMemory(reader, fileName);
	...
	public MT_Data_Language_Chinese_Simplified GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Language_Chinese_Simplified key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Language_Chinese_Simplified> Datas() {
		return m_dataArray;
	}
