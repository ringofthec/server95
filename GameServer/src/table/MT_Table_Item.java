...
public class MT_Table_Item extends MT_TableBase {
	final String FILE_MD5_CODE = "1e4edb3beb0f5ada11e683f7a6419dda";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Item> m_dataArray = new HashMap<Integer,MT_Data_Item>();

    public MT_Table_Item (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Item pData = MT_Data_Item.ReadMemory(reader, fileName);
	...
	public MT_Data_Item GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Item key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Item> Datas() {
		return m_dataArray;
	}
