...
public class MT_Table_Hero extends MT_TableBase {
	final String FILE_MD5_CODE = "0b940edbf9e946837faca6020a439248";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Hero> m_dataArray = new HashMap<Integer,MT_Data_Hero>();

    public MT_Table_Hero (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Hero pData = MT_Data_Hero.ReadMemory(reader, fileName);
	...
	public MT_Data_Hero GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Hero key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Hero> Datas() {
		return m_dataArray;
	}
