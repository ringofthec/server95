...
public class MT_Data_Language_CN extends MT_DataBase {
    ...
    public static MT_Data_Language_CN ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_Language_CN Data = new MT_Data_Language_CN();
