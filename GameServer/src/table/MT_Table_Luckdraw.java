...
public class MT_Table_Luckdraw extends MT_TableBase {
	final String FILE_MD5_CODE = "58cf0a5bdad0a9d353e9ab7430325581";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Luckdraw> m_dataArray = new HashMap<Integer,MT_Data_Luckdraw>();

    public MT_Table_Luckdraw (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Luckdraw pData = MT_Data_Luckdraw.ReadMemory(reader, fileName);
	...
	public MT_Data_Luckdraw GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Luckdraw key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Luckdraw> Datas() {
		return m_dataArray;
	}
