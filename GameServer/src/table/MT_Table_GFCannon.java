...
public class MT_Table_GFCannon extends MT_TableBase {
	final String FILE_MD5_CODE = "a17dd4658dea72e236533cc9571e81bf";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GFCannon> m_dataArray = new HashMap<Integer,MT_Data_GFCannon>();

    public MT_Table_GFCannon (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GFCannon pData = MT_Data_GFCannon.ReadMemory(reader, fileName);
	...
	public MT_Data_GFCannon GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GFCannon key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GFCannon> Datas() {
		return m_dataArray;
	}
