...
public class MT_Table_main extends MT_TableBase {
	final String FILE_MD5_CODE = "02150abd689a47578b698a11d2472bdc";
    private String fileName = "";
    private HashMap<Integer,MT_Data_main> m_dataArray = new HashMap<Integer,MT_Data_main>();

    public MT_Table_main (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_main pData = MT_Data_main.ReadMemory(reader, fileName);
	...
	public MT_Data_main GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_main key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_main> Datas() {
		return m_dataArray;
	}
