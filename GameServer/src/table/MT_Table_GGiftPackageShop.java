...
public class MT_Table_GGiftPackageShop extends MT_TableBase {
	final String FILE_MD5_CODE = "8d7de63a732b298531ac17dd3f047643";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GGiftPackageShop> m_dataArray = new HashMap<Integer,MT_Data_GGiftPackageShop>();

    public MT_Table_GGiftPackageShop (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GGiftPackageShop pData = MT_Data_GGiftPackageShop.ReadMemory(reader, fileName);
	...
	public MT_Data_GGiftPackageShop GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GGiftPackageShop key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GGiftPackageShop> Datas() {
		return m_dataArray;
	}
