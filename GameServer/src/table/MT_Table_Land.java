...
public class MT_Table_Land extends MT_TableBase {
	final String FILE_MD5_CODE = "e86ae79a635a5873c9bdd36058e73cb7";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Land> m_dataArray = new HashMap<Integer,MT_Data_Land>();

    public MT_Table_Land (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Land pData = MT_Data_Land.ReadMemory(reader, fileName);
	...
	public MT_Data_Land GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Land key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Land> Datas() {
		return m_dataArray;
	}
