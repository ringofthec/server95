...
public class MT_Table_Rampart extends MT_TableBase {
	final String FILE_MD5_CODE = "606423c60d5779d0d06d0620188f0f5f";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Rampart> m_dataArray = new HashMap<Integer,MT_Data_Rampart>();

    public MT_Table_Rampart (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Rampart pData = MT_Data_Rampart.ReadMemory(reader, fileName);
	...
	public MT_Data_Rampart GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Rampart key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Rampart> Datas() {
		return m_dataArray;
	}
