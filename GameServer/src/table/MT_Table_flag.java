...
public class MT_Table_flag extends MT_TableBase {
	final String FILE_MD5_CODE = "afb1882862329f3b2cd69a4b72119404";
    private String fileName = "";
    private HashMap<Integer,MT_Data_flag> m_dataArray = new HashMap<Integer,MT_Data_flag>();

    public MT_Table_flag (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_flag pData = MT_Data_flag.ReadMemory(reader, fileName);
	...
	public MT_Data_flag GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_flag key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_flag> Datas() {
		return m_dataArray;
	}
