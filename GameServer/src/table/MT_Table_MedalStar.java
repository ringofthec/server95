...
public class MT_Table_MedalStar extends MT_TableBase {
	final String FILE_MD5_CODE = "0097049daf79fca327c59af1b53142bc";
    private String fileName = "";
    private HashMap<Integer,MT_Data_MedalStar> m_dataArray = new HashMap<Integer,MT_Data_MedalStar>();

    public MT_Table_MedalStar (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_MedalStar pData = MT_Data_MedalStar.ReadMemory(reader, fileName);
	...
	public MT_Data_MedalStar GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_MedalStar key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_MedalStar> Datas() {
		return m_dataArray;
	}
