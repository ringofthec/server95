...
public class MT_Table_Spawn extends MT_TableBase {
	final String FILE_MD5_CODE = "eaed85ecd44581f88fa73c399fd92784";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Spawn> m_dataArray = new HashMap<Integer,MT_Data_Spawn>();

    public MT_Table_Spawn (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Spawn pData = MT_Data_Spawn.ReadMemory(reader, fileName);
	...
	public MT_Data_Spawn GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Spawn key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Spawn> Datas() {
		return m_dataArray;
	}
