...
public class MT_Data_Language_EN extends MT_DataBase {
    ...
    public static MT_Data_Language_EN ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_Language_EN Data = new MT_Data_Language_EN();
