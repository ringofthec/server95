...
public class MT_Data_EquipB extends MT_DataBase {
    ...
    public static MT_Data_EquipB ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_EquipB Data = new MT_Data_EquipB();
