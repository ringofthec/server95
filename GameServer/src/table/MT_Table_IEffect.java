...
public class MT_Table_IEffect extends MT_TableBase {
	final String FILE_MD5_CODE = "6e09f1e5554db2b5e8aa1dd1f9c26c99";
    private String fileName = "";
    private HashMap<Integer,MT_Data_IEffect> m_dataArray = new HashMap<Integer,MT_Data_IEffect>();

    public MT_Table_IEffect (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_IEffect pData = MT_Data_IEffect.ReadMemory(reader, fileName);
	...
	public MT_Data_IEffect GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_IEffect key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_IEffect> Datas() {
		return m_dataArray;
	}
