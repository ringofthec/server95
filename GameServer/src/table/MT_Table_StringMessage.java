...
public class MT_Table_StringMessage extends MT_TableBase {
	final String FILE_MD5_CODE = "249721b2fe5808ee034bb22ee4278830";
    private String fileName = "";
    private HashMap<String,MT_Data_StringMessage> m_dataArray = new HashMap<String,MT_Data_StringMessage>();

    public MT_Table_StringMessage (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_StringMessage pData = MT_Data_StringMessage.ReadMemory(reader, fileName);
	...
	public MT_Data_StringMessage GetElement(String ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_StringMessage key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<String,MT_Data_StringMessage> Datas() {
		return m_dataArray;
	}
