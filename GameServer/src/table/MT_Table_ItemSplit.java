...
public class MT_Table_ItemSplit extends MT_TableBase {
	final String FILE_MD5_CODE = "05aef2ce3fd97cb1acab31e1afd35058";
    private String fileName = "";
    private HashMap<Integer,MT_Data_ItemSplit> m_dataArray = new HashMap<Integer,MT_Data_ItemSplit>();

    public MT_Table_ItemSplit (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_ItemSplit pData = MT_Data_ItemSplit.ReadMemory(reader, fileName);
	...
	public MT_Data_ItemSplit GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_ItemSplit key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_ItemSplit> Datas() {
		return m_dataArray;
	}
