...
public class MT_Table_Language_EN extends MT_TableBase {
	final String FILE_MD5_CODE = "d36ddc515f0354dd5c43c7ebdbbac1b0";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_Language_EN> m_dataArray = new HashMap<Integer,MT_Data_Language_EN>();

    public MT_Table_Language_EN (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Language_EN pData = MT_Data_Language_EN.ReadMemory(reader, fileName);
	...
	public MT_Data_Language_EN GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Language_EN key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Language_EN> Datas() {
		return m_dataArray;
	}
