...
public class MT_Table_GFSkill extends MT_TableBase {
	final String FILE_MD5_CODE = "1738f97d8db7257d6ed8a45a83b10dac";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GFSkill> m_dataArray = new HashMap<Integer,MT_Data_GFSkill>();

    public MT_Table_GFSkill (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GFSkill pData = MT_Data_GFSkill.ReadMemory(reader, fileName);
	...
	public MT_Data_GFSkill GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GFSkill key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GFSkill> Datas() {
		return m_dataArray;
	}
