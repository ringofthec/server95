...
public class MT_Table_LoginMail extends MT_TableBase {
	final String FILE_MD5_CODE = "dc5de17369c8691942e992293560bd78";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LoginMail> m_dataArray = new HashMap<Integer,MT_Data_LoginMail>();

    public MT_Table_LoginMail (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LoginMail pData = MT_Data_LoginMail.ReadMemory(reader, fileName);
	...
	public MT_Data_LoginMail GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LoginMail key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LoginMail> Datas() {
		return m_dataArray;
	}
