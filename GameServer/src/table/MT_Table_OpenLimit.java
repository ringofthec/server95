...
public class MT_Table_OpenLimit extends MT_TableBase {
	final String FILE_MD5_CODE = "38cb0b4070c9d0c2abaed03d1c97ead9";
    private String fileName = "";
    private HashMap<Integer,MT_Data_OpenLimit> m_dataArray = new HashMap<Integer,MT_Data_OpenLimit>();

    public MT_Table_OpenLimit (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_OpenLimit pData = MT_Data_OpenLimit.ReadMemory(reader, fileName);
	...
	public MT_Data_OpenLimit GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_OpenLimit key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_OpenLimit> Datas() {
		return m_dataArray;
	}
