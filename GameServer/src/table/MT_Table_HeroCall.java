...
public class MT_Table_HeroCall extends MT_TableBase {
	final String FILE_MD5_CODE = "d63efd3a3f6c2b14325086aeda80b71c";
    private String fileName = "";
    private HashMap<Integer,MT_Data_HeroCall> m_dataArray = new HashMap<Integer,MT_Data_HeroCall>();

    public MT_Table_HeroCall (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_HeroCall pData = MT_Data_HeroCall.ReadMemory(reader, fileName);
	...
	public MT_Data_HeroCall GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_HeroCall key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_HeroCall> Datas() {
		return m_dataArray;
	}
