...
public class MT_Table_GStoreItem extends MT_TableBase {
	final String FILE_MD5_CODE = "1ea2dc711c0dbcaa233e503feba033e8";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GStoreItem> m_dataArray = new HashMap<Integer,MT_Data_GStoreItem>();

    public MT_Table_GStoreItem (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GStoreItem pData = MT_Data_GStoreItem.ReadMemory(reader, fileName);
	...
	public MT_Data_GStoreItem GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GStoreItem key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GStoreItem> Datas() {
		return m_dataArray;
	}
