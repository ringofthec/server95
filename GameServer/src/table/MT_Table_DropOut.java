...
public class MT_Table_DropOut extends MT_TableBase {
	final String FILE_MD5_CODE = "ee6f3037bb66d21d3be54b984c8ddd57";
    private String fileName = "";
    private HashMap<Integer,MT_Data_DropOut> m_dataArray = new HashMap<Integer,MT_Data_DropOut>();

    public MT_Table_DropOut (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        String strClassMD5CodeInt6 = TableUtil.ReadString(reader);
        if (!strClassMD5CodeInt6.equals(Int6.MD5))
            throw new Exception("文件" + fileName + "的自定义类[Int6]已被修改");
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_DropOut pData = MT_Data_DropOut.ReadMemory(reader, fileName);
	...
	public MT_Data_DropOut GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_DropOut key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_DropOut> Datas() {
		return m_dataArray;
	}
