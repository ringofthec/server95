...
public class MT_Table_IntensifyConfig extends MT_TableBase {
	final String FILE_MD5_CODE = "f200407c57df57cc4012811ef6e809f8";
    private String fileName = "";
    private HashMap<Integer,MT_Data_IntensifyConfig> m_dataArray = new HashMap<Integer,MT_Data_IntensifyConfig>();

    public MT_Table_IntensifyConfig (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_IntensifyConfig pData = MT_Data_IntensifyConfig.ReadMemory(reader, fileName);
	...
	public MT_Data_IntensifyConfig GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_IntensifyConfig key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_IntensifyConfig> Datas() {
		return m_dataArray;
	}
