...
public class MT_Table_Vip extends MT_TableBase {
	final String FILE_MD5_CODE = "9857ea5baefc457412923e4131305cb6";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Vip> m_dataArray = new HashMap<Integer,MT_Data_Vip>();

    public MT_Table_Vip (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Vip pData = MT_Data_Vip.ReadMemory(reader, fileName);
	...
	public MT_Data_Vip GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Vip key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Vip> Datas() {
		return m_dataArray;
	}
