...
public class MT_Table_GPromptInfo extends MT_TableBase {
	final String FILE_MD5_CODE = "d0adc85eaa4aedc7433a8c558846bf38";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GPromptInfo> m_dataArray = new HashMap<Integer,MT_Data_GPromptInfo>();

    public MT_Table_GPromptInfo (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GPromptInfo pData = MT_Data_GPromptInfo.ReadMemory(reader, fileName);
	...
	public MT_Data_GPromptInfo GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GPromptInfo key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GPromptInfo> Datas() {
		return m_dataArray;
	}
