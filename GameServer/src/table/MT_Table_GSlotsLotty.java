...
public class MT_Table_GSlotsLotty extends MT_TableBase {
	final String FILE_MD5_CODE = "ae074592b8620079c74c218d0303c68c";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsLotty> m_dataArray = new HashMap<Integer,MT_Data_GSlotsLotty>();

    public MT_Table_GSlotsLotty (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsLotty pData = MT_Data_GSlotsLotty.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsLotty GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsLotty key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsLotty> Datas() {
		return m_dataArray;
	}
