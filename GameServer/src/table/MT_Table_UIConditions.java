...
public class MT_Table_UIConditions extends MT_TableBase {
	final String FILE_MD5_CODE = "ee311d149c62c6a4ed065c692fe13bdd";
    private String fileName = "";
    private HashMap<Integer,MT_Data_UIConditions> m_dataArray = new HashMap<Integer,MT_Data_UIConditions>();

    public MT_Table_UIConditions (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_UIConditions pData = MT_Data_UIConditions.ReadMemory(reader, fileName);
	...
	public MT_Data_UIConditions GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_UIConditions key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_UIConditions> Datas() {
		return m_dataArray;
	}
