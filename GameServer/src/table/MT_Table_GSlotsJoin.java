...
public class MT_Table_GSlotsJoin extends MT_TableBase {
	final String FILE_MD5_CODE = "4af24d12b4f110663154bf2466e9313c";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsJoin> m_dataArray = new HashMap<Integer,MT_Data_GSlotsJoin>();

    public MT_Table_GSlotsJoin (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsJoin pData = MT_Data_GSlotsJoin.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsJoin GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsJoin key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsJoin> Datas() {
		return m_dataArray;
	}
