...
public class MT_Table_TimeRewardConfig extends MT_TableBase {
	final String FILE_MD5_CODE = "4514275caaaef9c13b050929bbcc5a7c";
    private String fileName = "";
    private HashMap<Integer,MT_Data_TimeRewardConfig> m_dataArray = new HashMap<Integer,MT_Data_TimeRewardConfig>();

    public MT_Table_TimeRewardConfig (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_TimeRewardConfig pData = MT_Data_TimeRewardConfig.ReadMemory(reader, fileName);
	...
	public MT_Data_TimeRewardConfig GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_TimeRewardConfig key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_TimeRewardConfig> Datas() {
		return m_dataArray;
	}
