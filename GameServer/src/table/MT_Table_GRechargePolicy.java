...
public class MT_Table_GRechargePolicy extends MT_TableBase {
	final String FILE_MD5_CODE = "77b3d8773b760f91f733898ee8e4335a";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GRechargePolicy> m_dataArray = new HashMap<Integer,MT_Data_GRechargePolicy>();

    public MT_Table_GRechargePolicy (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GRechargePolicy pData = MT_Data_GRechargePolicy.ReadMemory(reader, fileName);
	...
	public MT_Data_GRechargePolicy GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GRechargePolicy key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GRechargePolicy> Datas() {
		return m_dataArray;
	}
