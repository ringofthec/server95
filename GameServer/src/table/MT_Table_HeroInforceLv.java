...
public class MT_Table_HeroInforceLv extends MT_TableBase {
	final String FILE_MD5_CODE = "05d5f50f384ced05b9bb111b79a1bbb0";
    private String fileName = "";
    private HashMap<Integer,MT_Data_HeroInforceLv> m_dataArray = new HashMap<Integer,MT_Data_HeroInforceLv>();

    public MT_Table_HeroInforceLv (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_HeroInforceLv pData = MT_Data_HeroInforceLv.ReadMemory(reader, fileName);
	...
	public MT_Data_HeroInforceLv GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_HeroInforceLv key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_HeroInforceLv> Datas() {
		return m_dataArray;
	}
