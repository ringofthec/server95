...
public class MT_Table_ItemStrengthen extends MT_TableBase {
	final String FILE_MD5_CODE = "c78dd1aadd674ba94ff7e97932cb72a9";
    private String fileName = "";
    private HashMap<Integer,MT_Data_ItemStrengthen> m_dataArray = new HashMap<Integer,MT_Data_ItemStrengthen>();

    public MT_Table_ItemStrengthen (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_ItemStrengthen pData = MT_Data_ItemStrengthen.ReadMemory(reader, fileName);
	...
	public MT_Data_ItemStrengthen GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_ItemStrengthen key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_ItemStrengthen> Datas() {
		return m_dataArray;
	}
