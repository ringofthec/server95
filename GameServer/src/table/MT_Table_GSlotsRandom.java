...
public class MT_Table_GSlotsRandom extends MT_TableBase {
	final String FILE_MD5_CODE = "14cd244264d28edb0d980274e50dfbe9";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsRandom> m_dataArray = new HashMap<Integer,MT_Data_GSlotsRandom>();

    public MT_Table_GSlotsRandom (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsRandom pData = MT_Data_GSlotsRandom.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsRandom GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsRandom key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsRandom> Datas() {
		return m_dataArray;
	}
