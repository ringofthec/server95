...
public class MT_Table_Recharge1 extends MT_TableBase {
	final String FILE_MD5_CODE = "46a5ef6ec5af43ab871d28bd735559a2";
    private String fileName = "";
    private HashMap<String,MT_Data_Recharge1> m_dataArray = new HashMap<String,MT_Data_Recharge1>();

    public MT_Table_Recharge1 (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Recharge1 pData = MT_Data_Recharge1.ReadMemory(reader, fileName);
	...
	public MT_Data_Recharge1 GetElement(String ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Recharge1 key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<String,MT_Data_Recharge1> Datas() {
		return m_dataArray;
	}
