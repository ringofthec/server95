...
public class MT_Table_GSlotsOpen extends MT_TableBase {
	final String FILE_MD5_CODE = "f874d91100b7d53e28cd9b47947cd398";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsOpen> m_dataArray = new HashMap<Integer,MT_Data_GSlotsOpen>();

    public MT_Table_GSlotsOpen (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsOpen pData = MT_Data_GSlotsOpen.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsOpen GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsOpen key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsOpen> Datas() {
		return m_dataArray;
	}
