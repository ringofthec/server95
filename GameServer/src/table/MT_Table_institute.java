...
public class MT_Table_institute extends MT_TableBase {
	final String FILE_MD5_CODE = "d753c2aa288657d6ae741a503b0aee99";
    private String fileName = "";
    private HashMap<Integer,MT_Data_institute> m_dataArray = new HashMap<Integer,MT_Data_institute>();

    public MT_Table_institute (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_institute pData = MT_Data_institute.ReadMemory(reader, fileName);
	...
	public MT_Data_institute GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_institute key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_institute> Datas() {
		return m_dataArray;
	}
