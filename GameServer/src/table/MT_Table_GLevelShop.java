...
public class MT_Table_GLevelShop extends MT_TableBase {
	final String FILE_MD5_CODE = "aaffdfba440aaaa349ba62fcb7e68c34";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GLevelShop> m_dataArray = new HashMap<Integer,MT_Data_GLevelShop>();

    public MT_Table_GLevelShop (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GLevelShop pData = MT_Data_GLevelShop.ReadMemory(reader, fileName);
	...
	public MT_Data_GLevelShop GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GLevelShop key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GLevelShop> Datas() {
		return m_dataArray;
	}
