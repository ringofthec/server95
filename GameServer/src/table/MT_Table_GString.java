...
public class MT_Table_GString extends MT_TableBase {
	final String FILE_MD5_CODE = "2b989c19a30d4b00cb09a8ce82bfbee6";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GString> m_dataArray = new HashMap<Integer,MT_Data_GString>();

    public MT_Table_GString (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GString pData = MT_Data_GString.ReadMemory(reader, fileName);
	...
	public MT_Data_GString GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GString key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GString> Datas() {
		return m_dataArray;
	}
