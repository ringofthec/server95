...
public class MT_Table_HeroInforce extends MT_TableBase {
	final String FILE_MD5_CODE = "8567aebd24f849066b178a931a752229";
    private String fileName = "";
    private HashMap<Integer,MT_Data_HeroInforce> m_dataArray = new HashMap<Integer,MT_Data_HeroInforce>();

    public MT_Table_HeroInforce (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_HeroInforce pData = MT_Data_HeroInforce.ReadMemory(reader, fileName);
	...
	public MT_Data_HeroInforce GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_HeroInforce key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_HeroInforce> Datas() {
		return m_dataArray;
	}
