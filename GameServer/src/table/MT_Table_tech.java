...
public class MT_Table_tech extends MT_TableBase {
	final String FILE_MD5_CODE = "2d5a50e60c29050dd5230f47e30afdae";
    private String fileName = "";
    private HashMap<Integer,MT_Data_tech> m_dataArray = new HashMap<Integer,MT_Data_tech>();

    public MT_Table_tech (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_tech pData = MT_Data_tech.ReadMemory(reader, fileName);
	...
	public MT_Data_tech GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_tech key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_tech> Datas() {
		return m_dataArray;
	}
