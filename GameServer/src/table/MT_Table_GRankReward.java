...
public class MT_Table_GRankReward extends MT_TableBase {
	final String FILE_MD5_CODE = "31cce2ed22e3f5d451613745920339f8";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GRankReward> m_dataArray = new HashMap<Integer,MT_Data_GRankReward>();

    public MT_Table_GRankReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GRankReward pData = MT_Data_GRankReward.ReadMemory(reader, fileName);
	...
	public MT_Data_GRankReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GRankReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GRankReward> Datas() {
		return m_dataArray;
	}
