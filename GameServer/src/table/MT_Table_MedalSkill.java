...
public class MT_Table_MedalSkill extends MT_TableBase {
	final String FILE_MD5_CODE = "540dd7db28e7202807d8749f6fd2efcd";
    private String fileName = "";
    private HashMap<Integer,MT_Data_MedalSkill> m_dataArray = new HashMap<Integer,MT_Data_MedalSkill>();

    public MT_Table_MedalSkill (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_MedalSkill pData = MT_Data_MedalSkill.ReadMemory(reader, fileName);
	...
	public MT_Data_MedalSkill GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_MedalSkill key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_MedalSkill> Datas() {
		return m_dataArray;
	}
