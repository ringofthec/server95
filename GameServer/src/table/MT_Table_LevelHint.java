...
public class MT_Table_LevelHint extends MT_TableBase {
	final String FILE_MD5_CODE = "486afa20aa9ae49a7210df00a5cf42f8";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LevelHint> m_dataArray = new HashMap<Integer,MT_Data_LevelHint>();

    public MT_Table_LevelHint (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LevelHint pData = MT_Data_LevelHint.ReadMemory(reader, fileName);
	...
	public MT_Data_LevelHint GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LevelHint key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LevelHint> Datas() {
		return m_dataArray;
	}
