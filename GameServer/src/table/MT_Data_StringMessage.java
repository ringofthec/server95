...
public class MT_Data_StringMessage extends MT_DataBase {
    ...
    public static MT_Data_StringMessage ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_StringMessage Data = new MT_Data_StringMessage();
