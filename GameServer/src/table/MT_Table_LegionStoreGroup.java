...
public class MT_Table_LegionStoreGroup extends MT_TableBase {
	final String FILE_MD5_CODE = "f0fe0208bd15ccead40b0772c1bfe989";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LegionStoreGroup> m_dataArray = new HashMap<Integer,MT_Data_LegionStoreGroup>();

    public MT_Table_LegionStoreGroup (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LegionStoreGroup pData = MT_Data_LegionStoreGroup.ReadMemory(reader, fileName);
	...
	public MT_Data_LegionStoreGroup GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LegionStoreGroup key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LegionStoreGroup> Datas() {
		return m_dataArray;
	}
