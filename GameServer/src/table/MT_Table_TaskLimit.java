...
public class MT_Table_TaskLimit extends MT_TableBase {
	final String FILE_MD5_CODE = "d80bf4db8606e37e7645a78790568520";
    private String fileName = "";
    private HashMap<Integer,MT_Data_TaskLimit> m_dataArray = new HashMap<Integer,MT_Data_TaskLimit>();

    public MT_Table_TaskLimit (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_TaskLimit pData = MT_Data_TaskLimit.ReadMemory(reader, fileName);
	...
	public MT_Data_TaskLimit GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_TaskLimit key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_TaskLimit> Datas() {
		return m_dataArray;
	}
