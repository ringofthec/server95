...
public class MT_Table_LegionStore extends MT_TableBase {
	final String FILE_MD5_CODE = "a71c149d64c67d47fa9a0226075a958e";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LegionStore> m_dataArray = new HashMap<Integer,MT_Data_LegionStore>();

    public MT_Table_LegionStore (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LegionStore pData = MT_Data_LegionStore.ReadMemory(reader, fileName);
	...
	public MT_Data_LegionStore GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LegionStore key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LegionStore> Datas() {
		return m_dataArray;
	}
