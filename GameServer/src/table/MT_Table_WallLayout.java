...
public class MT_Table_WallLayout extends MT_TableBase {
	final String FILE_MD5_CODE = "816f5a23d9af464f290390aaccdb7987";
    private String fileName = "";
    private HashMap<Integer,MT_Data_WallLayout> m_dataArray = new HashMap<Integer,MT_Data_WallLayout>();

    public MT_Table_WallLayout (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_WallLayout pData = MT_Data_WallLayout.ReadMemory(reader, fileName);
	...
	public MT_Data_WallLayout GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_WallLayout key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_WallLayout> Datas() {
		return m_dataArray;
	}
