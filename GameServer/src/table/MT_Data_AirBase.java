...
public class MT_Data_AirBase extends MT_DataBase {
    public static String MD5 = "a456dba79b68e21bfbbab912e7b31d9e";
    ...
    public static MT_Data_AirBase ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_AirBase Data = new MT_Data_AirBase();
