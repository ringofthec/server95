...
public class MT_Table_Queue extends MT_TableBase {
	final String FILE_MD5_CODE = "31f67aea39c25b0c9461c9b9bbbc1f4f";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Queue> m_dataArray = new HashMap<Integer,MT_Data_Queue>();

    public MT_Table_Queue (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Queue pData = MT_Data_Queue.ReadMemory(reader, fileName);
	...
	public MT_Data_Queue GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Queue key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Queue> Datas() {
		return m_dataArray;
	}
