...
public class MT_Table_GItem extends MT_TableBase {
	final String FILE_MD5_CODE = "5c8977b705a3bca8f477d5f3eb6dc268";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GItem> m_dataArray = new HashMap<Integer,MT_Data_GItem>();

    public MT_Table_GItem (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GItem pData = MT_Data_GItem.ReadMemory(reader, fileName);
	...
	public MT_Data_GItem GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GItem key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GItem> Datas() {
		return m_dataArray;
	}
