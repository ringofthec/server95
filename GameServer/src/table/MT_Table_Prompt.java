...
public class MT_Table_Prompt extends MT_TableBase {
	final String FILE_MD5_CODE = "15eb8944efca50937340cf08ae097757";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Prompt> m_dataArray = new HashMap<Integer,MT_Data_Prompt>();

    public MT_Table_Prompt (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Prompt pData = MT_Data_Prompt.ReadMemory(reader, fileName);
	...
	public MT_Data_Prompt GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Prompt key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Prompt> Datas() {
		return m_dataArray;
	}
