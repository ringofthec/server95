...
public class MT_Table_TeachInstance extends MT_TableBase {
	final String FILE_MD5_CODE = "f64c9ea12caa276865954e0da68ae987";
    private String fileName = "";
    private HashMap<Integer,MT_Data_TeachInstance> m_dataArray = new HashMap<Integer,MT_Data_TeachInstance>();

    public MT_Table_TeachInstance (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_TeachInstance pData = MT_Data_TeachInstance.ReadMemory(reader, fileName);
	...
	public MT_Data_TeachInstance GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_TeachInstance key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_TeachInstance> Datas() {
		return m_dataArray;
	}
