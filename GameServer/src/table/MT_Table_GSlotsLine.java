...
public class MT_Table_GSlotsLine extends MT_TableBase {
	final String FILE_MD5_CODE = "6616d323be676c81a5fe192e635f1524";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsLine> m_dataArray = new HashMap<Integer,MT_Data_GSlotsLine>();

    public MT_Table_GSlotsLine (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsLine pData = MT_Data_GSlotsLine.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsLine GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsLine key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsLine> Datas() {
		return m_dataArray;
	}
