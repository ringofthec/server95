...
public class MT_Table_TimeReward extends MT_TableBase {
	final String FILE_MD5_CODE = "3a1e7c2266521e393420c01239439bad";
    private String fileName = "";
    private HashMap<Integer,MT_Data_TimeReward> m_dataArray = new HashMap<Integer,MT_Data_TimeReward>();

    public MT_Table_TimeReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_TimeReward pData = MT_Data_TimeReward.ReadMemory(reader, fileName);
	...
	public MT_Data_TimeReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_TimeReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_TimeReward> Datas() {
		return m_dataArray;
	}
