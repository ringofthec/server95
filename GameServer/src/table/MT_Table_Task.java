...
public class MT_Table_Task extends MT_TableBase {
	final String FILE_MD5_CODE = "8c3894ea12d0dc19ab50bc7ec21341ce";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Task> m_dataArray = new HashMap<Integer,MT_Data_Task>();

    public MT_Table_Task (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Task pData = MT_Data_Task.ReadMemory(reader, fileName);
	...
	public MT_Data_Task GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Task key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Task> Datas() {
		return m_dataArray;
	}
