...
public class MT_Table_GSlotsFriutActiveReward extends MT_TableBase {
	final String FILE_MD5_CODE = "e4654ebc200428c27c364af8712e0f09";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GSlotsFriutActiveReward> m_dataArray = new HashMap<Integer,MT_Data_GSlotsFriutActiveReward>();

    public MT_Table_GSlotsFriutActiveReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GSlotsFriutActiveReward pData = MT_Data_GSlotsFriutActiveReward.ReadMemory(reader, fileName);
	...
	public MT_Data_GSlotsFriutActiveReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GSlotsFriutActiveReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GSlotsFriutActiveReward> Datas() {
		return m_dataArray;
	}
