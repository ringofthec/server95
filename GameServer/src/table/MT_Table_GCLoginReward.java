...
public class MT_Table_GCLoginReward extends MT_TableBase {
	final String FILE_MD5_CODE = "9ded84d9ffafd9bceb85dccb77fc62f3";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GCLoginReward> m_dataArray = new HashMap<Integer,MT_Data_GCLoginReward>();

    public MT_Table_GCLoginReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GCLoginReward pData = MT_Data_GCLoginReward.ReadMemory(reader, fileName);
	...
	public MT_Data_GCLoginReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GCLoginReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GCLoginReward> Datas() {
		return m_dataArray;
	}
