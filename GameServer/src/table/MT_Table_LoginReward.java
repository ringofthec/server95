...
public class MT_Table_LoginReward extends MT_TableBase {
	final String FILE_MD5_CODE = "6aff1ca97b90246682042e2895e1f237";
    private String fileName = "";
    private HashMap<Integer,MT_Data_LoginReward> m_dataArray = new HashMap<Integer,MT_Data_LoginReward>();

    public MT_Table_LoginReward (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_LoginReward pData = MT_Data_LoginReward.ReadMemory(reader, fileName);
	...
	public MT_Data_LoginReward GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_LoginReward key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_LoginReward> Datas() {
		return m_dataArray;
	}
