...
public class MT_Data_LegionBuild extends MT_DataBase {
    ...
    public static MT_Data_LegionBuild ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_LegionBuild Data = new MT_Data_LegionBuild();
