...
public class MT_Table_Head extends MT_TableBase {
	final String FILE_MD5_CODE = "24b4e6a79466fa7a06468303cf5ba15d";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Head> m_dataArray = new HashMap<Integer,MT_Data_Head>();

    public MT_Table_Head (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Head pData = MT_Data_Head.ReadMemory(reader, fileName);
	...
	public MT_Data_Head GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Head key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Head> Datas() {
		return m_dataArray;
	}
