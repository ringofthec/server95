...
public class MT_Table_GBJLHelpTable extends MT_TableBase {
	final String FILE_MD5_CODE = "fb89d21968b21ade5cb4aa0de0d3175f";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GBJLHelpTable> m_dataArray = new HashMap<Integer,MT_Data_GBJLHelpTable>();

    public MT_Table_GBJLHelpTable (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GBJLHelpTable pData = MT_Data_GBJLHelpTable.ReadMemory(reader, fileName);
	...
	public MT_Data_GBJLHelpTable GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GBJLHelpTable key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GBJLHelpTable> Datas() {
		return m_dataArray;
	}
