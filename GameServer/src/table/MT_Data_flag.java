...
public class MT_Data_flag extends MT_DataBase {
    public static String MD5 = "f057977a0f9ee5c981a58ea2d1a3d847";
    ...
    public static MT_Data_flag ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_flag Data = new MT_Data_flag();
