...
public class MT_Table_MedalAttribute extends MT_TableBase {
	final String FILE_MD5_CODE = "f3101a19a88f21316a1e2b7fecebc083";
    private String fileName = "";
    private HashMap<Integer,MT_Data_MedalAttribute> m_dataArray = new HashMap<Integer,MT_Data_MedalAttribute>();

    public MT_Table_MedalAttribute (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_MedalAttribute pData = MT_Data_MedalAttribute.ReadMemory(reader, fileName);
	...
	public MT_Data_MedalAttribute GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_MedalAttribute key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_MedalAttribute> Datas() {
		return m_dataArray;
	}
