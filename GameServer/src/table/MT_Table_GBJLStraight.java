...
public class MT_Table_GBJLStraight extends MT_TableBase {
	final String FILE_MD5_CODE = "e48398bf170c29bfea0dea6f0fe0f8f7";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GBJLStraight> m_dataArray = new HashMap<Integer,MT_Data_GBJLStraight>();

    public MT_Table_GBJLStraight (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GBJLStraight pData = MT_Data_GBJLStraight.ReadMemory(reader, fileName);
	...
	public MT_Data_GBJLStraight GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GBJLStraight key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GBJLStraight> Datas() {
		return m_dataArray;
	}
