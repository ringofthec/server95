...
public class MT_Table_factory extends MT_TableBase {
	final String FILE_MD5_CODE = "b24938c207ee2033395bc5c00fc0f7a0";
    private String fileName = "";
    private HashMap<Integer,MT_Data_factory> m_dataArray = new HashMap<Integer,MT_Data_factory>();

    public MT_Table_factory (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_factory pData = MT_Data_factory.ReadMemory(reader, fileName);
	...
	public MT_Data_factory GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_factory key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_factory> Datas() {
		return m_dataArray;
	}
