...
public class MT_Table_Building extends MT_TableBase {
	final String FILE_MD5_CODE = "00c0d9fc217897aa6d01255865024e35";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Building> m_dataArray = new HashMap<Integer,MT_Data_Building>();

    public MT_Table_Building (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Building pData = MT_Data_Building.ReadMemory(reader, fileName);
	...
	public MT_Data_Building GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Building key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Building> Datas() {
		return m_dataArray;
	}
