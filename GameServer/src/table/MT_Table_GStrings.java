...
public class MT_Table_GStrings extends MT_TableBase {
	final String FILE_MD5_CODE = "956ada8e11965494220817799901cc38";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GStrings> m_dataArray = new HashMap<Integer,MT_Data_GStrings>();

    public MT_Table_GStrings (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GStrings pData = MT_Data_GStrings.ReadMemory(reader, fileName);
	...
	public MT_Data_GStrings GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GStrings key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GStrings> Datas() {
		return m_dataArray;
	}
