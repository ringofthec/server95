...
public class MT_Table_GRechargeBack extends MT_TableBase {
	final String FILE_MD5_CODE = "1620e58bc17deaa0aba900924a905123";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GRechargeBack> m_dataArray = new HashMap<Integer,MT_Data_GRechargeBack>();

    public MT_Table_GRechargeBack (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GRechargeBack pData = MT_Data_GRechargeBack.ReadMemory(reader, fileName);
	...
	public MT_Data_GRechargeBack GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GRechargeBack key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GRechargeBack> Datas() {
		return m_dataArray;
	}
