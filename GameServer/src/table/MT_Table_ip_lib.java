...
public class MT_Table_ip_lib extends MT_TableBase {
	final String FILE_MD5_CODE = "060b505a2cba64387ef91d38d9dde4ef";
    private String fileName = "";
    private HashMap<String,MT_Data_ip_lib> m_dataArray = new HashMap<String,MT_Data_ip_lib>();

    public MT_Table_ip_lib (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_ip_lib pData = MT_Data_ip_lib.ReadMemory(reader, fileName);
	...
	public MT_Data_ip_lib GetElement(String ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_ip_lib key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<String,MT_Data_ip_lib> Datas() {
		return m_dataArray;
	}
