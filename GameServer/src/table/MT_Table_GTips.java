...
public class MT_Table_GTips extends MT_TableBase {
	final String FILE_MD5_CODE = "7121d173e3fa28f90d64767bbd69c0c7";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GTips> m_dataArray = new HashMap<Integer,MT_Data_GTips>();

    public MT_Table_GTips (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GTips pData = MT_Data_GTips.ReadMemory(reader, fileName);
	...
	public MT_Data_GTips GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GTips key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GTips> Datas() {
		return m_dataArray;
	}
