...
public class MT_Data_GNiuBet extends MT_DataBase {
    ...
    public static MT_Data_GNiuBet ReadMemory ( ByteBuffer reader, String fileName ) {
        MT_Data_GNiuBet Data = new MT_Data_GNiuBet();
