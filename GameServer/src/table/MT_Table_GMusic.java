...
public class MT_Table_GMusic extends MT_TableBase {
	final String FILE_MD5_CODE = "48acd506a7199e382bc2f27111086ace";
    private String fileName = "";
	private Boolean newFlag = true;
    private HashMap<Integer,MT_Data_GMusic> m_dataArray = new HashMap<Integer,MT_Data_GMusic>();

    public MT_Table_GMusic (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_GMusic pData = MT_Data_GMusic.ReadMemory(reader, fileName);
	...
	public MT_Data_GMusic GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_GMusic key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_GMusic> Datas() {
		return m_dataArray;
	}
