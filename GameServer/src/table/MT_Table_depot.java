...
public class MT_Table_depot extends MT_TableBase {
	final String FILE_MD5_CODE = "24b142b2dbb5dc4ccd207acd0b188fd2";
    private String fileName = "";
    private HashMap<Integer,MT_Data_depot> m_dataArray = new HashMap<Integer,MT_Data_depot>();

    public MT_Table_depot (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_depot pData = MT_Data_depot.ReadMemory(reader, fileName);
	...
	public MT_Data_depot GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_depot key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_depot> Datas() {
		return m_dataArray;
	}
