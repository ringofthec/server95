...
public class MT_Table_PushEvent extends MT_TableBase {
	final String FILE_MD5_CODE = "c679bd3563709f22930ba35b535dc23a";
    private String fileName = "";
    private HashMap<Integer,MT_Data_PushEvent> m_dataArray = new HashMap<Integer,MT_Data_PushEvent>();

    public MT_Table_PushEvent (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_PushEvent pData = MT_Data_PushEvent.ReadMemory(reader, fileName);
	...
	public MT_Data_PushEvent GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_PushEvent key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_PushEvent> Datas() {
		return m_dataArray;
	}
