...
public class MT_Table_Skill extends MT_TableBase {
	final String FILE_MD5_CODE = "6572107c8c7a4fdf708b1c242f5c5ffa";
    private String fileName = "";
    private HashMap<Integer,MT_Data_Skill> m_dataArray = new HashMap<Integer,MT_Data_Skill>();

    public MT_Table_Skill (String fileName) {
    ...
    public void Initialize() throws Exception {
        ...
        for (Integer i = 0; i < iRow; ++i) {
            MT_Data_Skill pData = MT_Data_Skill.ReadMemory(reader, fileName);
	...
	public MT_Data_Skill GetElement(Integer ID) {
		if (Contains(ID))
			return m_dataArray.get(ID);
        TableUtil.Warning("MT_Data_Skill key is not exist " + ID);
		return null;
	}
	...
	public final HashMap<Integer,MT_Data_Skill> Datas() {
		return m_dataArray;
	}
